...
/* ecopy's one-shot compatibility API and runtime backend diagnostic. */
BLAKE3_API void blake3_hash(const void *data, size_t len,
                            uint8_t out[BLAKE3_OUT_LEN]);
BLAKE3_API const char *blake3_backend(void);
