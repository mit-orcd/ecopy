...
void stats_inc_symlink_seen(void);
void stats_inc_symlink_created(void);
void stats_inc_hardlink_seen(void);
void stats_inc_hardlink_created(void);
...
/* Enable/disable current-file slot maintenance (verbose on-TTY display only). */
